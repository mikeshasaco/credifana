                            ...
                            <div class="text-center">
                                ...
                                <div class="panel-body mt-4">
                                    <form id="login-form" action="{{ route('log-in') }}" role="form" autocomplete="off" class="form" method="post">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="email" class="form-control" required id="loginEmail" placeholder="Email Address" name="email" >
                                            </div>
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="password" class="form-control" id="password" autocomplete="true" placeholder="Password" name="password">
                                            </div>
                                        </div>
                                    ...
                                    <div class="registerFormLink mt-1">
                                        ...
                                        <div class="text"><a href="{{ route('forgot-password') }}" class="registerLink">Forgot Password</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
